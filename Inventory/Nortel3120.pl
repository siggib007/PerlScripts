...
$tblName = "tblDevices";
$Where   = "vcType = 'NOR 3120'";
$DBHost  = "localhost";
$DBName  = "inventory";
$DBUser  = "script";
$DBpwd   = "test123";

$getOIDs{"chassisSerialNumber"}     = "1.3.6.1.4.1.562.73.1.1.1.2.2.0";
$getOIDs{"chassisType"}     = "1.3.6.1.4.1.562.73.1.1.1.2.1.0";
$getOIDs{"sysVersion"}   = "1.3.6.1.4.1.562.73.1.1.1.1.1.4.0";
...
while (my $ref = $sth->fetchrow_hashref()) 
{
  ...
  $DeviceIP   = $ref->{'vcIPaddr'}; 
	...
	{
		$strSQL = "update tblDevices set vcSerialNo='$outhash{chassisSerialNumber}', ";
		$strSQL .= "vcModel='$outhash{chassisType}', vcVersion='$outhash{sysVersion}', ";
		$strSQL .= "vcUpdatedby='$host', dtUpdatedAt=now() ";
