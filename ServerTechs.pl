...
$getOIDs{"systemNICSerialNumber"} = "1.3.6.1.4.1.1718.3.1.2.0";
$getOIDs{"systemVersion"}         = "1.3.6.1.4.1.1718.3.1.1.0";
...
#			last;
	...
	{
		$strSQL = "update tblDevices set vcSerialNo='$outhash{systemNICSerialNumber}', ";
		$strSQL .= "vcVersion='$outhash{systemVersion}', ";
